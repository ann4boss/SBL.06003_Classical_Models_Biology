...
# In the first example (r1 = 12, r2 = 10, alpha11 = 1.6, alpha22 = 1.7, 
# gamma12 = 0.5, gamma21 = 0.3), the model produces a coexistence equilibrium in 
# the positive quadrant, and the vector field clearly converges toward this point.
...
# self-limitation stabilises the system. Such dynamics could describe, for example, 
# plant-pollinator systems with saturation or diminishing returns.
...
# The trajectory diverges from the purple point, despite starting nearby.
# The Jacobian matrix has at least one eigenvalue with a positive real part, 
# indicating local instability.
# The vector field flows away from the equilibrium, suggesting that small 
# perturbations grow over time.


# Biological interpretation:
# Mutualistic interactions are too strong compared to self-limitation. A small 
# boost in one species reinforces the other, leading to potential runaway growth 
# or collapse. This reflects mutualism-induced instability, a known theoretical 
# risk in obligate mutualisms.
